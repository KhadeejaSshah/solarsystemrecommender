...
export default function ApplianceStaging({ onComplete, onChange }: ApplianceStagingProps) {
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto min-h-[850px] flex flex-col items-center overflow-hidden py-20 px-4 dark:bg-[#0a0f1c]">
      ...
      <div className="text-center mb-24 relative z-10 flex-shrink-0">
        <motion.h1
          ...
          className="text-4xl md:text-5xl font-black text-gray-400 dark:text-white tracking-tighter mb-4"
        >
        ...
        <motion.p
          ...
          className="text-gray-500 dark:text-solar-text/40 text-lg font-medium"
        >
      ...
      <div className="relative w-full flex-1 flex items-center justify-center perspective-[2000px]">
        ...
        <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex justify-between px-4 md:px-12 z-50 pointer-events-none">
          <button
            ...
            className={cn(
              "p-4 rounded-full dark:bg-solar-navy/80 border border-gray-200 dark:border-white/10 text-gray-700 dark:text-white backdrop-blur-xl transition-all pointer-events-auto shadow-lg dark:shadow-[0_0_20px_rgba(0,0,0,0.5)]",
            ...
            {APPLIANCES_LIST.map((appliance, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    "absolute w-[320px] md:w-[360px] h-[480px] rounded-[3rem] p-8 flex flex-col items-center justify-between overflow-hidden border transition-all",
                    isActive
                      ? " dark:bg-[#0a0f1c]/95 backdrop-blur-3xl border-solar-electric/60 shadow-2xl dark:shadow-[0_30px_100px_rgba(0,194,255,0.25)]"
                      : "/80 dark:bg-[#0a0f1c]/50 backdrop-blur-xl border-gray-200 dark:border-white/10"
                  )}
                >
                  {/* Active Glow Border */}
                  {isActive && (
                  ...
                  <div className="flex flex-col items-center w-full relative z-10">
                    ...
                    <p className="text-gray-500 dark:text-solar-text/40 font-bold uppercase tracking-widest text-[10px] mb-6">
                    ...
                    <div className="w-full px-4 mb-2">
                      {appliance.options ? (
                        <div className="relative">
                          <button
                            ...
                            className={cn(
                              ...
                              isActive
                                ? " dark:/5 border-gray-300 dark:border-white/20 text-gray-700 dark:text-white hover:bg-gray-50 dark:hover:/10"
                                : "bg-gray-10 dark:/5 border-gray-200 dark:border-white/10 text-gray-400 dark:text-white/50"
                            )}
                          >
                          ...
                          <AnimatePresence>
                            {selectedVariants[`dropdown-${appliance.id}`] && isActive && (
                              <motion.div
                                ...
                                exit={{ opacity: 0, y: 10 }}
                                className="absolute bottom-full left-0 right-0 mb-2  dark:bg-solar-navy border border-gray-200 dark:border-white/10 rounded-2xl p-2 shadow-xl z-50"
                              >
                        ...
                        <div className="w-full px-6 py-4 rounded-2xl bg-gray-10 dark:/5 border border-gray-200 dark:border-white/10 text-center text-sm text-gray-500 dark:text-white/30">
                  ...
                  <div className="w-full space-y-3 relative z-10 mt-auto">
                    <div className="flex items-center justify-between bg-gray-10 dark:/5 rounded-2xl p-2 border border-gray-200 dark:border-white/10">
                      <button
                        disabled={!isActive}
                        onClick={() => updateQuantity(appliance.id, qty - 1)}
                        className="p-3 hover: dark:hover:/10 rounded-xl transition-colors disabled:opacity-40 text-gray-700 dark:text-white"
                      >
                        <Minus className="w-5 h-5" />
                      </button>
                      <span className="font-black text-3xl text-gray-900 dark:text-white">{qty}</span>
                      <button
                        disabled={!isActive}
                        onClick={() => updateQuantity(appliance.id, qty + 1)}
                        className="p-3 hover: dark:hover:/10 rounded-xl transition-colors disabled:opacity-40 text-gray-700 dark:text-white"
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isActive
                          ...
                          : "bg-gray-20 dark:/10 text-gray-400 dark:text-white/30 cursor-not-allowed"
                      )}
                    >
      ...
      <motion.div
        layout
        className="fixed bottom-12 left-1/2 -translate-x-1/2 w-full max-w-xs p-2 /95 dark:bg-solar-navy/95 backdrop-blur-2xl border border-gray-200 dark:border-white/10 rounded-[2.5rem] shadow-2xl z-[100]"
      >
        <button
          ...
          className={cn(
            ...
            selectedAppliances.length > 0
              ...
              : "bg-gray-10 dark:/5 text-gray-400 dark:text-white/30 cursor-not-allowed border border-gray-200 dark:border-white/10"
          )}
        >
