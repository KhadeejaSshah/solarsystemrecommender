...
//       <group position={[2.5, 5.7, -0.8]}>
//         <mesh rotation={[0, 0, 0.18]} material={materials.darkRoof}>
//           <boxGeometry args={[6, 0.25, 5.5]} />
//         </mesh>

//         <group position={[0, 0.3, -0.5]} rotation={[0, 0, 0.18]}>
...
export const ModernHouseModel = ({ 
  ...
  const materials = useMemo(() => {
    ...
    return {
      ...
      // NEW: deck for rooftop terrace
      deck: new THREE.MeshStandardMaterial({ 
        color: '#EDE0C8', roughness: 0.85, metalness: 0.05 
      })
    };
  }, [isDark]);
  ...
  return (
    <group>
      ...
      {/* ====================== NEW: ROOFTOP TERRACE (chairs + railing + bonfire) ====================== */}
      {/* Positioned on the flat moss roof, offset left to avoid pitched roof / solar panels */}
      <group position={[-5.2, 3.55, 1]}>
        {/* Terrace wooden deck floor */}
        <mesh position={[0, 0, 0]} material={materials.deck} castShadow receiveShadow>
          <boxGeometry args={[5.5, 0.12, 4]} />
        </mesh>

        {/* === RAILING (modern thin style, matching balcony) === */}
        {/* Top horizontal rails */}
        <mesh position={[0, 0.75, -2]} material={materials.fence}>
          <boxGeometry args={[5.5, 0.06, 0.06]} />
        </mesh>
        <mesh position={[0, 0.75, 2]} material={materials.fence}>
          <boxGeometry args={[5.5, 0.06, 0.06]} />
        </mesh>
        <mesh position={[-2.75, 0.75, 0]} material={materials.fence} rotation={[0, Math.PI / 2, 0]}>
        ...
        {/* Vertical posts (every ~0.7 units) */}
        {/* Front */}
        {[...Array(9)].map((_, i) => (
          <mesh
            key={`front-post-${i}`}
            position={[-2.75 + i * 0.69, 0.35, -2]}
        ...
        {/* === BONFIRE AREA (center of terrace) === */}
        <group position={[0, 0.1, 0]}>
          {/* Fire pit ring / stone border */}
          <mesh position={[0, 0.05, 0]} material={materials.rockBase}>
            <cylinderGeometry args={[0.85, 0.95, 0.22, 24]} />
          </mesh>
          {/* Inner pit floor */}
          <mesh position={[0, 0.02, 0]} material={materials.rockBase}>
            <cylinderGeometry args={[0.65, 0.65, 0.08, 24]} />
          </mesh>

          {/* Logs (crossed) */}
          <mesh position={[0.05, 0.25, 0]} material={materials.wood} rotation={[0.3, 0, Math.PI / 3.5]}>
            <cylinderGeometry args={[0.07, 0.07, 1.25, 8]} />
          </mesh>
          <mesh position={[-0.05, 0.25, 0]} material={materials.wood} rotation={[0.3, 0, -Math.PI / 3.5]}>
            <cylinderGeometry args={[0.07, 0.07, 1.25, 8]} />
          </mesh>
          <mesh position={[0, 0.22, 0.1]} material={materials.wood} rotation={[0.8, Math.PI / 4, 0]}>
            <cylinderGeometry args={[0.06, 0.06, 0.9, 8]} />
          </mesh>

          {/* Flames (multiple glowing cones for realistic look) */}
          <mesh position={[0.12, 0.55, 0.08]} material={new THREE.MeshStandardMaterial({ color: '#FF4500', emissive: '#FF8C00', emissiveIntensity: 3.2, roughness: 0 })}>
            <coneGeometry args={[0.13, 0.65, 5]} />
          </mesh>
          <mesh position={[-0.15, 0.48, -0.12]} material={new THREE.MeshStandardMaterial({ color: '#FF4500', emissive: '#FFAA00', emissiveIntensity: 2.8, roughness: 0 })} rotation={[0, 1.2, 0.4]}>
            <coneGeometry args={[0.11, 0.72, 5]} />
          </mesh>
          <mesh position={[0.05, 0.52, -0.18]} material={new THREE.MeshStandardMaterial({ color: '#FFB800', emissive: '#FFEE00', emissiveIntensity: 2.5, roughness: 0 })} rotation={[0.3, -0.8, 0]}>
            <coneGeometry args={[0.09, 0.55, 5]} />
          </mesh>
          <mesh position={[-0.08, 0.6, 0.15]} material={new THREE.MeshStandardMaterial({ color: '#FF4500', emissive: '#FF6600', emissiveIntensity: 3, roughness: 0 })} rotation={[0, 2.1, -0.3]}>
            <coneGeometry args={[0.14, 0.68, 5]} />
          </mesh>
        </group>

        {/* === CHAIRS (4 modern lounge chairs arranged around the bonfire) === */}
        {/* Chair 1 - front right, facing bonfire */}
        <group position={[1.8, 0.05, 1.1]} rotation={[0, -2.4, 0]}>
          {/* Seat */}
          <mesh position={[0, 0.35, 0]} material={materials.wood}>
            <boxGeometry args={[0.55, 0.08, 0.55]} />
          </mesh>
          {/* Backrest */}
          <mesh position={[0, 0.72, -0.22]} material={materials.wood}>
            <boxGeometry args={[0.55, 0.52, 0.08]} />
          </mesh>
          {/* Legs */}
          <mesh position={[-0.22, 0.12, -0.22]} material={materials.wood}>
        ...
        {/* Chair 2 - front left, facing bonfire */}
        <group position={[-1.7, 0.05, 1.05]} rotation={[0, 2.4, 0]}>
          {/* Seat */}
          <mesh position={[0, 0.35, 0]} material={materials.wood}>
            <boxGeometry args={[0.55, 0.08, 0.55]} />
          </mesh>
        ...
        {/* Chair 3 - back right, facing bonfire */}
        <group position={[1.75, 0.05, -1.3]} rotation={[0, -0.7, 0]}>
          {/* Seat */}
          <mesh position={[0, 0.35, 0]} material={materials.wood}>
            <boxGeometry args={[0.55, 0.08, 0.55]} />
          </mesh>
        ...
        {/* Chair 4 - back left, facing bonfire */}
        <group position={[-1.8, 0.05, -1.25]} rotation={[0, 0.7, 0]}>
          {/* Seat */}
          <mesh position={[0, 0.35, 0]} material={materials.wood}>
            <boxGeometry args={[0.55, 0.08, 0.55]} />
          </mesh>
