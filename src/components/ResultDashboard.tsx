...
// import { 
//   Settings, X, Trash2, TrendingUp, Share2, Download, User, MapPin 
// } from 'lucide-react';
...
//       <div className="max-w-[1680px] mx-auto w-full flex-1 flex flex-col gap-6 min-h-0">   {/* Wider container */}
...
//         {/* Main Content - Expanded horizontally */}
...
//           {/* LEFT SIDE - Kept bigger (house visual priority) */}
...
//                   {isDark ? "Emergency Storage" : "Solar Harvesting Active"}
//                 </div>
...
//               className="absolute top-8 right-8 z-50 flex items-center gap-3 bg-white/10 hover:bg-white/20 backdrop-blur-xl border border-white/20 rounded-2xl px-5 py-3 transition-all group"
//             >
...
//                   className="absolute top-24 right-8 z-50 w-96 bg-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl p-6 shadow-2xl"
//                 >
...
//           {/* RIGHT SIDEBAR - Expanded + No Scroll */}
//           <div className="flex-[0.82] flex flex-col gap-5 p-9 bg-solar-card/90 rounded-r-[2.5rem] overflow-hidden">

//             {/* System Summary */}
//             <div className="rounded-2xl bg-white/10 p-7 backdrop-blur-md flex-shrink-0">
...
//             {/* Stability Index */}
//             <div className="rounded-2xl bg-white/10 p-7 backdrop-blur-md flex-shrink-0">
//               <h3 className="uppercase text-xs tracking-widest font-bold mb-3 flex items-center gap-2">
//                 <TrendingUp className="w-4 h-4" />
//                 Market Volatility
//               </h3>
//               <div className="flex items-center justify-between mb-3">
//                 <span className="text-xs font-bold opacity-40 uppercase tracking-wider">Inflation Shield</span>
//                 <span className="text-sm font-black text-green-500">8.4 / 10</span>
//               </div>
...
//                 />
//               </div>
//               <p className="text-xs mt-4 leading-tight opacity-40 italic">
//                 Solar provides 84% more cost stability than grid-only over a 10-year period.
//               </p>
//             </div>

//             {/* Next Steps */}
//             <div className="rounded-2xl bg-white/10 p-7 backdrop-blur-md mt-auto flex-shrink-0">
