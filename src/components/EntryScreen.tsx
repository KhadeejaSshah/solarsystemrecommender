    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden p-6">
      ...
      <div className="relative z-10 max-w-4xl w-full text-center space-y-12">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-display font-bold text-solar-text leading-tight tracking-tighter">
            Your Energy, <br />
            <span className="text-solar-electric">Intelligently</span> Designed.
          </h1>
